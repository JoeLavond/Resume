...
\small
    ...
    \begin{p_item2}
        ...
        \item Designed architecture changes that prevent the occurrence of mode collapse in Generative Adversarial Networks (GANs)
    \end{p_item2}
    ...
    \begin{p_item2}
        ...
        \item Proposed Meta-Learning approach to model aggregation for Personalized Federated Learning (Submitted to ICLR 2024)
        \iftoggle{notes}{
        ...
        \item PyTorch implementation and multi-GPU training of computer vision models on Linux clusters
    \end{p_item2}
